...
/**
 * A DroitsStrategiePchE.
 */
@Entity
@Table(name = "droits_strategie_pch_e")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class DroitsStrategiePchE implements Serializable {
    ...
    public DroitsStrategiePchE id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public DroitsStrategiePchE isActif(Boolean isActif) {
    ...
    public DroitsStrategiePchE anne(Integer anne) {
        this.setAnne(anne);
        return this;
    }
    ...
    public DroitsStrategiePchE mois(Integer mois) {
        this.setMois(mois);
        return this;
    }
    ...
    public DroitsStrategiePchE montantPlafond(BigDecimal montantPlafond) {
    ...
    public DroitsStrategiePchE montantPlafondPlus(BigDecimal montantPlafondPlus) {
    ...
    public DroitsStrategiePchE nbHeurePlafond(BigDecimal nbHeurePlafond) {
    ...
    public DroitsStrategiePchE tauxCotisations(BigDecimal tauxCotisations) {
    ...
    public DroitsStrategiePchE dateOuverture(LocalDate dateOuverture) {
    ...
    public DroitsStrategiePchE dateFermeture(LocalDate dateFermeture) {
    ...
    public DroitsStrategiePchE beneficiaire(Beneficiaire beneficiaire) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DroitsStrategiePchE)) {
            return false;
        }
        return id != null && id.equals(((DroitsStrategiePchE) o).id);
    }
