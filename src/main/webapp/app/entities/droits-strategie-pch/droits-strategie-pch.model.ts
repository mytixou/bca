...
export interface IDroitsStrategiePch {
  id?: number;
  isActif?: boolean;
  anne?: number;
  mois?: number;
...
export class DroitsStrategiePch implements IDroitsStrategiePch {
  constructor(
    public id?: number,
...
export function getDroitsStrategiePchIdentifier(droitsStrategiePch: IDroitsStrategiePch): number | undefined {
  return droitsStrategiePch.id;
}
