...
describe('ConsommationApa e2e test', () => {
  ...
  it('should load ConsommationApas', async () => {
    ...
    expect(await consommationApaComponentsPage.getTitle()).to.eq('bcaApp.consommationApa.home.title');
    await browser.wait(
  ...
  it('should load create ConsommationApa page', async () => {
    ...
    expect(await consommationApaUpdatePage.getPageTitle()).to.eq('bcaApp.consommationApa.home.createOrEditLabel');
  ...
  it('should delete last ConsommationApa', async () => {
    ...
    expect(await consommationApaDeleteDialog.getDialogTitle()).to.eq('bcaApp.consommationApa.delete.question');
