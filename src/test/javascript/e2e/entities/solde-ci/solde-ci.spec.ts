...
describe('SoldeCi e2e test', () => {
  ...
  it('should load SoldeCis', async () => {
    ...
    expect(await soldeCiComponentsPage.getTitle()).to.eq('bcaApp.soldeCi.home.title');
  ...
  it('should load create SoldeCi page', async () => {
    ...
    expect(await soldeCiUpdatePage.getPageTitle()).to.eq('bcaApp.soldeCi.home.createOrEditLabel');
  ...
  it('should delete last SoldeCi', async () => {
    ...
    expect(await soldeCiDeleteDialog.getDialogTitle()).to.eq('bcaApp.soldeCi.delete.question');
