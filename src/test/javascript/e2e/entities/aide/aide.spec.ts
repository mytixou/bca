...
describe('Aide e2e test', () => {
  ...
  it('should load Aides', async () => {
    ...
    expect(await aideComponentsPage.getTitle()).to.eq('bcaApp.aide.home.title');
  ...
  it('should load create Aide page', async () => {
    ...
    expect(await aideUpdatePage.getPageTitle()).to.eq('bcaApp.aide.home.createOrEditLabel');
  ...
  it('should delete last Aide', async () => {
    ...
    expect(await aideDeleteDialog.getDialogTitle()).to.eq('bcaApp.aide.delete.question');
