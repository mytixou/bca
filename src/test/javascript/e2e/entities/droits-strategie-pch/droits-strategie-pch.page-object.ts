...
export class DroitsStrategiePchComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-droits-strategie-pch div table .btn-danger'));
  title = element.all(by.css('jhi-droits-strategie-pch div h2#page-heading span')).first();
...
export class DroitsStrategiePchUpdatePage {
  pageTitle = element(by.id('jhi-droits-strategie-pch-heading'));
...
export class DroitsStrategiePchDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-droitsStrategiePch-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-droitsStrategiePch'));
