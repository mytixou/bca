...
export class StrategieCmgGedComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-strategie-cmg-ged div table .btn-danger'));
  title = element.all(by.css('jhi-strategie-cmg-ged div h2#page-heading span')).first();
...
export class StrategieCmgGedUpdatePage {
  pageTitle = element(by.id('jhi-strategie-cmg-ged-heading'));
...
export class StrategieCmgGedDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-strategieCmgGed-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-strategieCmgGed'));
