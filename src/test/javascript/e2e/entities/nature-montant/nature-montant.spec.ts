...
describe('NatureMontant e2e test', () => {
  ...
  it('should load NatureMontants', async () => {
    ...
    expect(await natureMontantComponentsPage.getTitle()).to.eq('bcaApp.natureMontant.home.title');
    await browser.wait(
  ...
  it('should load create NatureMontant page', async () => {
    ...
    expect(await natureMontantUpdatePage.getPageTitle()).to.eq('bcaApp.natureMontant.home.createOrEditLabel');
  ...
  it('should delete last NatureMontant', async () => {
    ...
    expect(await natureMontantDeleteDialog.getDialogTitle()).to.eq('bcaApp.natureMontant.delete.question');
