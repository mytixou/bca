...
describe('ConsommationPchE e2e test', () => {
  ...
  it('should load ConsommationPchES', async () => {
    ...
    expect(await consommationPchEComponentsPage.getTitle()).to.eq('bcaApp.consommationPchE.home.title');
    await browser.wait(
  ...
  it('should load create ConsommationPchE page', async () => {
    ...
    expect(await consommationPchEUpdatePage.getPageTitle()).to.eq('bcaApp.consommationPchE.home.createOrEditLabel');
  ...
  it('should delete last ConsommationPchE', async () => {
    ...
    expect(await consommationPchEDeleteDialog.getDialogTitle()).to.eq('bcaApp.consommationPchE.delete.question');
