...
describe('ConsommationCi e2e test', () => {
  ...
  it('should load ConsommationCis', async () => {
    ...
    expect(await consommationCiComponentsPage.getTitle()).to.eq('bcaApp.consommationCi.home.title');
    await browser.wait(
  ...
  it('should load create ConsommationCi page', async () => {
    ...
    expect(await consommationCiUpdatePage.getPageTitle()).to.eq('bcaApp.consommationCi.home.createOrEditLabel');
  ...
  it('should delete last ConsommationCi', async () => {
    ...
    expect(await consommationCiDeleteDialog.getDialogTitle()).to.eq('bcaApp.consommationCi.delete.question');
