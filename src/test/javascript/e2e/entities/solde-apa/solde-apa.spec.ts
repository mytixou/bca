...
describe('SoldeApa e2e test', () => {
  ...
  it('should load SoldeApas', async () => {
    ...
    expect(await soldeApaComponentsPage.getTitle()).to.eq('bcaApp.soldeApa.home.title');
  ...
  it('should load create SoldeApa page', async () => {
    ...
    expect(await soldeApaUpdatePage.getPageTitle()).to.eq('bcaApp.soldeApa.home.createOrEditLabel');
  ...
  it('should delete last SoldeApa', async () => {
    ...
    expect(await soldeApaDeleteDialog.getDialogTitle()).to.eq('bcaApp.soldeApa.delete.question');
