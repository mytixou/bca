...
describe('TiersFinanceur e2e test', () => {
  ...
  it('should load TiersFinanceurs', async () => {
    ...
    expect(await tiersFinanceurComponentsPage.getTitle()).to.eq('bcaApp.tiersFinanceur.home.title');
    await browser.wait(
  ...
  it('should load create TiersFinanceur page', async () => {
    ...
    expect(await tiersFinanceurUpdatePage.getPageTitle()).to.eq('bcaApp.tiersFinanceur.home.createOrEditLabel');
  ...
  it('should delete last TiersFinanceur', async () => {
    ...
    expect(await tiersFinanceurDeleteDialog.getDialogTitle()).to.eq('bcaApp.tiersFinanceur.delete.question');
