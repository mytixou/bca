...
describe('ConsommationPch e2e test', () => {
  ...
  it('should load ConsommationPches', async () => {
    ...
    expect(await consommationPchComponentsPage.getTitle()).to.eq('bcaApp.consommationPch.home.title');
    await browser.wait(
  ...
  it('should load create ConsommationPch page', async () => {
    ...
    expect(await consommationPchUpdatePage.getPageTitle()).to.eq('bcaApp.consommationPch.home.createOrEditLabel');
  ...
  it('should delete last ConsommationPch', async () => {
    ...
    expect(await consommationPchDeleteDialog.getDialogTitle()).to.eq('bcaApp.consommationPch.delete.question');
