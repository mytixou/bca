...
describe('StrategieCi e2e test', () => {
  ...
  it('should load StrategieCis', async () => {
    ...
    expect(await strategieCiComponentsPage.getTitle()).to.eq('bcaApp.strategieCi.home.title');
    await browser.wait(
  ...
  it('should load create StrategieCi page', async () => {
    ...
    expect(await strategieCiUpdatePage.getPageTitle()).to.eq('bcaApp.strategieCi.home.createOrEditLabel');
  ...
  it('should delete last StrategieCi', async () => {
    ...
    expect(await strategieCiDeleteDialog.getDialogTitle()).to.eq('bcaApp.strategieCi.delete.question');
