...
export class DroitsStrategiePchEComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-droits-strategie-pch-e div table .btn-danger'));
  title = element.all(by.css('jhi-droits-strategie-pch-e div h2#page-heading span')).first();
...
export class DroitsStrategiePchEUpdatePage {
  pageTitle = element(by.id('jhi-droits-strategie-pch-e-heading'));
...
export class DroitsStrategiePchEDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-droitsStrategiePchE-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-droitsStrategiePchE'));
