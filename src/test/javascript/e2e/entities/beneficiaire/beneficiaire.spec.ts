...
describe('Beneficiaire e2e test', () => {
  ...
  it('should load Beneficiaires', async () => {
    ...
    expect(await beneficiaireComponentsPage.getTitle()).to.eq('bcaApp.beneficiaire.home.title');
    await browser.wait(
  ...
  it('should load create Beneficiaire page', async () => {
    ...
    expect(await beneficiaireUpdatePage.getPageTitle()).to.eq('bcaApp.beneficiaire.home.createOrEditLabel');
  ...
  it('should delete last Beneficiaire', async () => {
    ...
    expect(await beneficiaireDeleteDialog.getDialogTitle()).to.eq('bcaApp.beneficiaire.delete.question');
