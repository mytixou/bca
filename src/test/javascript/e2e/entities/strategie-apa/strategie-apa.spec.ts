...
describe('StrategieApa e2e test', () => {
  ...
  it('should load StrategieApas', async () => {
    ...
    expect(await strategieApaComponentsPage.getTitle()).to.eq('bcaApp.strategieApa.home.title');
    await browser.wait(
  ...
  it('should load create StrategieApa page', async () => {
    ...
    expect(await strategieApaUpdatePage.getPageTitle()).to.eq('bcaApp.strategieApa.home.createOrEditLabel');
  ...
  it('should delete last StrategieApa', async () => {
    ...
    expect(await strategieApaDeleteDialog.getDialogTitle()).to.eq('bcaApp.strategieApa.delete.question');
