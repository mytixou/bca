...
describe('SoldePch e2e test', () => {
  ...
  it('should load SoldePches', async () => {
    ...
    expect(await soldePchComponentsPage.getTitle()).to.eq('bcaApp.soldePch.home.title');
  ...
  it('should load create SoldePch page', async () => {
    ...
    expect(await soldePchUpdatePage.getPageTitle()).to.eq('bcaApp.soldePch.home.createOrEditLabel');
  ...
  it('should delete last SoldePch', async () => {
    ...
    expect(await soldePchDeleteDialog.getDialogTitle()).to.eq('bcaApp.soldePch.delete.question');
