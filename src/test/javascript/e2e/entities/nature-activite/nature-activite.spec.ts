...
describe('NatureActivite e2e test', () => {
  ...
  it('should load NatureActivites', async () => {
    ...
    expect(await natureActiviteComponentsPage.getTitle()).to.eq('bcaApp.natureActivite.home.title');
    await browser.wait(
  ...
  it('should load create NatureActivite page', async () => {
    ...
    expect(await natureActiviteUpdatePage.getPageTitle()).to.eq('bcaApp.natureActivite.home.createOrEditLabel');
  ...
  it('should delete last NatureActivite', async () => {
    ...
    expect(await natureActiviteDeleteDialog.getDialogTitle()).to.eq('bcaApp.natureActivite.delete.question');
